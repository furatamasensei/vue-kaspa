...
[Modul Nuxt](/id/guide/nuxt-module) menangani semua konfigurasi WASM/SSR secara otomatis — tidak perlu konfigurasi Vite manual. Ini mencakup `vite-plugin-wasm`, header COOP/COEP (dev dan produksi), `optimizeDeps.exclude`, dan SSR external. Komposabel di-auto-import.
